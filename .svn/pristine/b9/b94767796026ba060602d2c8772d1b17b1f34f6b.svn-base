	...
	<body>
		<div class="ui-form-container">
			<form name="form1" id="form1" method="post"
				action="${ctx}/res/opticcablemgr/glxx!list.action">
				...
				<div class="ui-form-input-box">
					...
					<baseinfo:regiontree widgetId="001" defaultValue="${map.regionid}"
						cls="ui-form-input" callBackId="regionCallBackId" regionId="${user.regionId}"
						 width="220" height="120"></baseinfo:regiontree>
