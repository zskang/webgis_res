...
<html>
	...
	<body>
		<div class="ui-form-container">
			<form name="form1" id="form1" method="post" action="${ctx}/res/groupcustomsmgr/campus!list.action">
				 <input type="hidden" id="serializeQueryCondition" name="serializeQueryCondition" />
				 <div class="ui-form-input-box">
				    <span class="ui-form-input-title">接入方式：</span>
					<baseinfo:dicselector keyValue="${searchCondition.jrfs}" name="jrfs"  columntype="JRFS" type="select" cssClass="ui-form-input" isQuery="query"></baseinfo:dicselector>
				 </div>
				 <div class="ui-form-input-box">
