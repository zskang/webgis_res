...
<title>信息</title>
    ...
    var url = ["${ctx}/res/publicmgr/zdxx!view.action?xtbh=${id}&tipview=1","${ctx}/contractor/search/zdxxdata_list.jsp?id=${id}"];
	In.ready(function() {
...
<body style="overflow: hidden">
   <div id="container">
        <ul id="navpoint">
			...
			<li><a href="#"><span class="nowtaskdetailcss"></span>巡检历史</a></li>
        </ul>
        <div></div>
        <div></div>
        <div></div>        
