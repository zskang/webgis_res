	...
	<body>
		<div class="ui-form-container">
			<form name="formname" id="formname" method="post"
				action="${ctx}/res/publicmgr/btssite!input.action">
			...
			<div class="ui-form-input-box">
					...
					<resinfo:resCommon keyValue="${entity.siteid}" tableName="res_zdxx"></resinfo:resCommon>
					</span>
				</div>
				<div class="ui-form-input-box">
					<span class="ui-form-input-title">所属机房:</span>
					<span class="ui-form-value">
					<resinfo:resCommon keyValue="${entity.roomid}" tableName="res_jf"></resinfo:resCommon>
					</span>
				</div>
				<div class="ui-form-input-box">
				...
				<div class="ui-form-input-box">
					...
					<span class="ui-form-value">
					<baseinfo:dicselector name="bslevel" columntype="BS_LEVEL" type="view" keyValue="${entity.bslevel}"></baseinfo:dicselector> </span>
				</div>
				<div class="ui-form-input-box">
					<span class="ui-form-input-title">设备型号：</span>
					<span class="ui-form-value"> 
					${entity.devicemodel}</span>
				</div>
				<div class="ui-form-input-box">
