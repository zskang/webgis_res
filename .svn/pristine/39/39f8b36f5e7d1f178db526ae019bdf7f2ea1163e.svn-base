		...
		<div class="ui-gis-banner"> 
			<div class="ui-gis-menu">
		        ...
		        <ul style="float:right">
			   	   ...
			   	   <li><a href="#" onclick="openResourcetreediv('公告信息','${ctx}/res/notice.action',880,600);" style="background:url('${ctx}/css/images/mail.png') 5px 3px no-repeat;padding-left:20px;width:90px;">未读公告(${messages})</a></li>
			   	   <li><a href="#" onclick="openResourcetreediv('消息日志','${ctx}/res/log.action',880,600);" style="background:url('${ctx}/css/images/clip.png') 5px 3px no-repeat;padding-left:20px;width:60px;">消息日志</a></li>
			   	   <li><a href="${config.logouturl}" style="background:url('${ctx}/css/images/power.png') 5px 3px no-repeat;padding-left:20px;width:45px;">退出</a></li>
			   	   <li>&nbsp;</li>
		        </ul>
		       </div>
			</div>
