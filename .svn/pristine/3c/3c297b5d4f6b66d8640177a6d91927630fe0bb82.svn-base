...
<body>
	<div class="ui-form-container">
		<form id="formname" name="formname" method="post" action="">
				...
				<c:if test="${entity.xtbh==null || entity.xtbh==''}">
					<div class="ui-form-input-box">
						<div style="width:100%;height:30px;">
							...
							<input type="button" value="选择坐标" onclick="javascript:top.addPoint('C34')" />
						</div>
					</div>
					<div class="ui-form-input-box">
				...
				<c:if test="${entity.xtbh!=null && entity.xtbh!=''}">
					<input type="hidden" name="pointX" id="pointX" value="${entity.lon}"/>
					<input type="hidden" name="pointY" id="pointY" value="${entity.lat}"/>
				</c:if>
			   <div class="ui-form-input-box">
			...
			<div class="ui-form-input-box">
				<span class="ui-form-input-title">承载业务信息：</span> <span
					...
					class="ui-form-input" type="text" value="${entity.czywxx}" />
				</span>
			</div>

			<div class="ui-form-input-box">
				<span class="ui-form-input-title">归属接入点名称：</span> <span
					class="ui-form-value"> <input id="gsjrdmc" name="gsjrdmc"
					class="ui-form-input" type="text" value="${entity.gsjrdmc}" />
				</span>
			</div>
	</div>
	...
	<div class="ui-form-input-box">
		<span class="ui-form-input-title">设备归属：</span> <span
			...
			class="ui-form-input" type="text" value="${entity.sbgs}" />
		</span>
	</div>
	...
	<div class="ui-form-input-box">
		<span class="ui-form-input-title">备注:</span> <span
			class="ui-form-value"> <input id="remark" name="remark"
			class="ui-form-input" type="text" value="${entity.remark}" />
		</span>
	</div>

	<div class="ui-form-input-box">
		<span class="ui-form-input-title">&nbsp;</span> <input type="submit"
			value="保存" onclick="doSubmit('save')" style="width: 80px;"> <input
