...
<html>
	<head>
	   ...
	   <script type="text/javascript">
	        ...
	        var checkGdd=function()
	        {
	            if($('#qdgj').val() != '' && $('#zdgj').val() != '')
	            {
	                 	$.ajax({
							   type: "POST",
							   dataType: "json",
							   url: "${ctx}/res/basemgr/gdd!checkGdd.action",
							   data: "qdgj="+$('#qdgj').val()+"&zdgj="+$('#zdgj').val(),
			...
			<form name="formname" id="formname" method="post" action="">
				...
				<div class="ui-form-input-box">
				 ...
				 <div class="ui-form-input-box">
					...
					<input id="zdgjinput" type="text" class="required ui-form-input" onblur="judgeHiddenValue(this,'zdgj');parseAZ('zdgjinput');checkGdd();"
				...
				<div class="ui-form-input-box">
					...
					<input type="text" class="ui-form-input number"   name="gddcd" id="gddcd" maxlength="30"
						value="${entity.gddcd}" 
						/>(米)
				</div>
				...
				<div class="ui-form-input-box">
					...
					<input type="text" class="ui-form-input number" name="qdgjms" id="qdgjms" maxlength="20"
						value="${entity.qdgjms}" />(米)
				</div>

				<div class="ui-form-input-box">
					<span class="ui-form-input-title">终端管井埋深：</span>
					<input type="text" class="ui-form-input number" name="zdgjms" id="zdgjms" maxlength="20"
						value="${entity.zdgjms}" />(米)
				</div>
