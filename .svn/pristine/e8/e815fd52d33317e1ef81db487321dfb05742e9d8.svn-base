	...
	<body>
		<div class="ui-form-container">
			<form name="form1" id="form1" method="post"
				action="${ctx}/res/groupcustomsmgr/groupcustoms!list.action">
				...
				<div class="ui-form-input-box">
					<span class="ui-form-input-title">集团客户名称：</span>
					<input type="text" class="required ui-form-input" name="groupname"
						id="groupname" value="${searchCondition.ymc}" />
				</div>
				<div class="ui-form-input-box">
					<span class="ui-form-input-title">集团客户级别：</span>
					<baseinfo:dicselector name="zyjb" columntype="JTKHJB"
						  type="select"
						keyValue="${searchCondition.zyjb}" cssClass="ui-form-input"
						isQuery="query"></baseinfo:dicselector>
				</div>
				<div class="ui-form-input-box">
					<span class="ui-form-input-title">客户类别：</span>
					<baseinfo:dicselector name="khlb" columntype="KHLB"
						  type="select" keyValue="${searchCondition.khlb}"
				...
				<div class="ui-form-input-box">
					...
					<baseinfo:regiontree defaultValue="${searchCondition.regionid}"
						widgetId="001" width="220" height="120" callBackId="regionCallBackId" cls="ui-form-input"
