		        ...
		        In.css('.ui-form-input {width:210px} .ui-form-input-title{width:100px}');
	         	...
	         	jQuery("#formname").validate({
					...
					submitHandler : function(form) {
						...
						$.ajax({
							url:'${ctx}/res/basemgr/bsxx!batchEdit.action',
							dataType:'html',
		...
		<div class="ui-form-container">
			<form id="formname" name="formname" method="post" action="">
				...
				<div class="ui-form-input-box">
					...
					<baseinfo:dicselector name="bsyt" columntype="SSYT" isQuery="query"
						type="select"   cssClass="ui-form-input"
						keyValue="${entity.bsyt}"></baseinfo:dicselector>
				</div>												
				...
				<div class="ui-form-input-box">
					<span class="ui-form-input-title">类型：</span>
					<baseinfo:dicselector name="bsjtlx" columntype="BSLX" isQuery="query"
						type="select"   cssClass="ui-form-input"
						keyValue="${entity.bsjtlx}"></baseinfo:dicselector>
				</div>				
