...
<title>信息</title>
    ...
    var url = ["${ctx}/contractor/patrolmaninfo!view.action?id=${id}","${ctx}/contractor/patrolmaninfo/patrolmancurrenttask_view.jsp?id=${id}","${ctx}/contractor/patrolmaninfo/patrolmancurrenttaskdetail_list.jsp?id=${id}"];
	In.ready(function() {
...
<body>
   <div id="container">
        <ul id="navpoint">
			...
			<li><a href="#"><span class="nowtaskdetailcss"></span>今日巡检明细</a></li>
        </ul>
        <div></div>
        <div></div>
        <div></div>        
