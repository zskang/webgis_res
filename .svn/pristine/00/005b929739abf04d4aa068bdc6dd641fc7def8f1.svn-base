	...
	<body>
		<div class="ui-form-container">
			<form name="form1" id="form1" method="post"
				action="${ctx}/res/cableequipmgr/gjt!list.action">
				...
				<div class="ui-form-input-box">
					<span class="ui-form-input-title">光接头类型：</span>
					<baseinfo:dicselector name="jtlx" columntype="GJTLX"
						  type="select"
						keyValue="${searchCondition.jtlx}" cssClass="ui-form-input"
