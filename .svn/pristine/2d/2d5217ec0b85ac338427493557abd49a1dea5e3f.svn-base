	...
	<body>
		<div class="ui-form-container">
			<form name="formname" id="formname" method="post"
				action="${ctx}/res/groupcustomsmgr/yyt!input.action">
				...
				<div class="ui-form-input-box">
				 ...
				 <span class="ui-form-value">${entity.yytbh}</span>
				</div>
				
				<div class="ui-form-input-box">
					<span class="ui-form-input-title">营业厅地址：</span>
					 <span class="ui-form-value">${entity.yytdz}</span>
				</div>

				<div class="ui-form-input-box">
					<span class="ui-form-input-title">联系人：</span>
					<span class="ui-form-value">${entity.lxr}</span>
				</div>

				<div class="ui-form-input-box">
					<span class="ui-form-input-title">联系电话：</span>
					<span class="ui-form-value">${entity.lxdh}</span>
				</div>

				<div class="ui-form-input-box">
					<span class="ui-form-input-title">数据更新状态：</span>
					 <span class="ui-form-value">
				    <baseinfo:dic displayProperty="LABLE" codevalue="${entity.sjgxzt}"
							columntype="SJGXZT"></baseinfo:dic>
					</span>
				</div>
				...
				<div class="ui-form-input-box">
					...
					<span class="ui-form-value">${entity.sjgxxx}</span>
				</div>
				...
				<div class="ui-form-input-box">
					<span class="ui-form-input-title"></span><span class="ui-form-value" style="float:right;margin-right:50px">
						<a href="${ctx}/res/groupcustomsmgr/yyt!input.action?xtbh=${entity.xtbh}">编辑</a>
					</span>	
				</div>
			</form>
		</div>
