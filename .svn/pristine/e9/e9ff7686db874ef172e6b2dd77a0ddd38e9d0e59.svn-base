...
<!--
	...
	In.ready('ztreejs','resztree',function(){
		...
		loadTree('tree','${ctx}/res/opticcablemgr/gldly!getTreeNodes.action?xtbh='+$("#xtbh").val());
		$('#rooturl').val('${ctx}/res/opticcablemgr/gldly!getTreeNodes.action?xtbh='+$("#xtbh").val());//设置资源树根链接地址
		$('#contentFrame').get(0).src = "${ctx}/res/opticcablemgr/gldly!view.action?xtbh="+$("#xtbh").val();
	});
//-->
</script>
	<body>
