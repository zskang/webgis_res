...
<html>
	...
	<body>
		<div class="ui-form-container">
			<form name="formname" id="formname" method="post" action="${ctx}/res/basemgr/gldxt!input.action">
				<input type="hidden" id="actmsg" name="actmsg" value="${entity.actionMessage}" />
				 ...
				 <div class="ui-form-input-box">
				    <span class="ui-form-input-title">电杆数：</span>
				    <span class="ui-form-value">${entity.dgs}(个)</span>
				 </div>
				 <div class="ui-form-input-box">
				...
				<div class="ui-form-input-box">
					<span class="ui-form-input-title"></span><span class="ui-form-value" style="float:right;margin-right:50px">
						<a href="${ctx}/res/basemgr/gldxt!input.action?xtbh=${entity.xtbh}">编辑</a>
					</span>	
				</div>				 
			</form>
		</div>
