	...
	<body>
		<div class="ui-form-container">
			<form name="form1" id="form1" method="post"
				action="${ctx}/res/publicmgr/zdxx!list.action">
				...
				<div class="ui-form-input-box">
					...
					<baseinfo:regiontree defaultValue="${searchCondition.regionid}" widgetId="001"
						 width="220" height="120" callBackId="regionCallBackId" regionId="${user.regionId}"
				...
				<div class="ui-form-input-box">
					...
					<input type="text" class="required ui-form-input" name="begintime"
