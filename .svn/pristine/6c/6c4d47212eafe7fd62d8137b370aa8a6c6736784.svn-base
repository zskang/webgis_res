...
<html>
	...
	<body>
		<div class="ui-form-container">
			<form name="form1" id="form1" method="post" action="${ctx}/res/basemgr/dgxx!list.action">
				<input type="hidden" id="serializeQueryCondition" name="serializeQueryCondition" />
				 ...
				 <div class="ui-form-input-box">
				    ...
				    <input type="text" class="ui-form-input Wdate" name="starttime" id="starttime" value="${searchCondition.starttime}" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"/>
				 </div>
				 <div class="ui-form-input-box">
				    <span class="ui-form-input-title">采集结束时间：</span>
				    <input type="text" class="ui-form-input Wdate" name="endtime" id="endtime" value="${searchCondition.endtime}" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"/>
				 </div>				 
				 <div class="ui-form-input-box">
