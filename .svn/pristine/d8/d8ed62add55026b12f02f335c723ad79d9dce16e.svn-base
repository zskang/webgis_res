				...
				//初始化RegionTree
	         	...
	         	jQuery("#formname").validate({
					...
					submitHandler : function(form) {
						...
						$.ajax({
							url:'${ctx}/res/basemgr/gdd!batchEdit.action',
							dataType:'html',
		...
		<div class="ui-form-container">
			<form name="formname" id="formname" method="post" action="">
				...
				<div class="ui-form-input-box">
					...
					<baseinfo:dicselector name="gdlx" keyValue="${entity.gdlx}" isQuery="query"
						columntype="GDLX" type="select"  style="width:218px"
				...
				<div class="ui-form-input-box">
					...
					<baseinfo:dicselector keyValue="${entity.sfgj}" name="sfgj" isQuery="query"
						columntype="SF" type="select"   style="width:218px" 
						cssClass="ui-form-input"></baseinfo:dicselector>
				</div>

				<div class="ui-form-input-box">
					<span class="ui-form-input-title">是否共享：</span>
					<baseinfo:dicselector keyValue="${entity.sfgx}" name="sfgx" isQuery="query"
						columntype="SF" type="select"  style="width:218px"
						cssClass="ui-form-input"></baseinfo:dicselector>
				</div>
