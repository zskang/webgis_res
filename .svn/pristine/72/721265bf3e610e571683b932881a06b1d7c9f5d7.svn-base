	...
	<body>
				...
				<c:if test="${entity.xtbh==null || entity.xtbh==''}">
					<div class="ui-form-input-box">
						<div style="width:100%;height:30px;">
							...
							<input type="button" value="选择坐标" onclick="javascript:top.addPoint('AA004')" />
						</div>
					</div>
					<div class="ui-form-input-box">
		...
		<div class="ui-form-input-box">
				...
				<div class="ui-form-input-box">
					...
					<input type="text" name="gfxxbh" id="gfxxbh" class="ui-form-input"
						value="${entity.gfxxbh}" maxlength="50" />
				</div>
				...
				<div class="ui-form-input-box">
					...
					<input type="text" class="ui-form-input" value="${entity.ggxh}"
						name="ggxh" id="ggxh"  maxlength="25" />
				</div>
				
				<div class="ui-form-input-box">
					<span class="ui-form-input-title">是否局内：</span>
					<baseinfo:dicselector name="sfjn" columntype="SF" type="select"
						keyValue="${entity.sfjn}"  
				...
				<div class="ui-form-input-box">
					...
					<input type="text" class="number ui-form-input required" value="${entity.ls}"
						name="ls" id="ls" maxlength="10" />
					<span class="ui-form-symbol-color">*</span>
				</div>
				<div class="ui-form-input-box">
					<span class="ui-form-input-title">列排列方式：</span>
					<baseinfo:dicselector name="lplfs" columntype="PLFS" type="select"
						keyValue="${entity.lplfs}"   isQuery="query" exclude="AD001,AD002,AD003,AD006"
						cssClass="required ui-form-input"></baseinfo:dicselector>
					<span class="ui-form-symbol-color">*</span>
				</div>
				<div class="ui-form-input-box">
					<span class="ui-form-input-title">每列模块数：</span>
					<input type="text" class="required number ui-form-input" value="${entity.lmks}"
				...
				<div class="ui-form-input-box">
					...
					<input type="text" class="required number ui-form-input" value="${entity.kls}"
						name="kls" id="kls" maxlength="10" />
					<span class="ui-form-symbol-color">*</span>
				</div>
				<div class="ui-form-input-box">
					<span class="ui-form-input-title">每块行数：</span>
					<input type="text" class="required number ui-form-input" value="${entity.khs}"
				...
				<div class="ui-form-input-box">
					...
					<input type="text" value="${entity.cjdw}" class="ui-form-input"
				...
				<div class="ui-form-input-box">
					...
					<input type="text" class="ui-form-input" value="${entity.ssglq}"
						name="ssglq" id="ssglq" maxlength="50" />
				</div>
				<div class="ui-form-input-box">
					<span class="ui-form-input-title">所属区域：</span>
					<baseinfo:regiontree  widgetId="001"
						defaultValue="${entity.regionid}" width="220"
						height="220" cls="required ui-form-input" 
