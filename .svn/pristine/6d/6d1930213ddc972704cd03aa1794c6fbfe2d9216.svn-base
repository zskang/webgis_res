	...
	<head>
		<script type="text/javascript">
			...
			var parseAZ = function(object){
			 ...
			 var checkGqd=function()
	        {
	            if($('#qdgqhidden').val() != '' && $('#zdgqhidden').val() != '')
	            {
	                 	$.ajax({
							   type: "POST",
							   dataType: "json",
							   url: "${ctx}/res/basemgr/gqd!checkGqd.action",
							   data: "qdgq="+$('#qdgqhidden').val()+"&zdgq="+$('#zdgqhidden').val(),
			...
			<form name="formname" id="formname" method="post" action="">
				...
				<div class="ui-form-input-box">
				 ...
				 <div class="ui-form-input-box">
					...
					<input id="zdgqinput" name="zdgqinput" class="required ui-form-input"  type="text" onblur="judgeHiddenValue(this,'zdgqhidden');parseAZ('zdgqinput');checkGqd();"  value='<resinfo:resCommon keyValue="${entity.zdgq}" tableName="res_gqxx"></resinfo:resCommon>'/>
