		        ...
		        In.css('.ui-form-input {width:210px} .ui-form-input-title{width:100px}');
	         	...
	         	jQuery("#formname").validate({
					...
					submitHandler : function(form) {
						...
						$.ajax({
							url:'${ctx}/res/basemgr/gld!batchEdit.action',
							dataType:'html',
		...
		<div class="ui-form-container">
			<form id="formname" name="formname" method="post" action="">
				...
				<div class="ui-form-input-box">
					...
					<baseinfo:dicselector name="yt" columntype="SSYT" isQuery="query"
				...
				<div class="ui-form-input-box">
					...
					<baseinfo:dicselector name="sfgj" columntype="SF" isQuery="query"
						type="select"   cssClass="ui-form-input"
				...
				<div class="ui-form-input-box">
					...
					<baseinfo:dicselector name="sfgx" columntype="SF" isQuery="query"
						type="select"   cssClass="ui-form-input"
