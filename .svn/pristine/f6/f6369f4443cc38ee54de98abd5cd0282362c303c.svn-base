		...
		<div class="ui-form-container">
			<form id="formname" name="formname" method="post" action="">
				...
				<div class="ui-form-input-box">
					...
					<input type="text" class="number ui-form-input" value="${entity.zcd}"
						name="zcd" id="zcd" />(米)
				</div>

				<!-- <div class="ui-form-input-box">
					<span class="ui-form-input-title">挂墙数量：</span>
					<input type="text" class="number ui-form-input" value="${entity.gqsl}"
						name="gqsl" id="gqsl" />
						<span class="ui-form-symbol-color">*</span>
				</div> -->
				...
				<div class="ui-form-input-box">
					<span class="ui-form-input-title">备注：</span>
								<textarea class="input textarea"  name="remark" maxlength="200"
									id="remark" style="width: 220px">${entity.remark}</textarea>
						</div>
