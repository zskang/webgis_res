...
// 待办工作操作列转换
function WaitHandjfxxFmatter(cellvalue, options, rowObjec) {
...
function viewThis(xtbh) {
	location = contextPath + '/res/publicmgr/jfxx!view.action?xtbh=' + xtbh;
}

function deleteThis(xtbh) {
	var url = contextPath + '/res/publicmgr/jfxx!deleteDwzh.action?xtbh=' + xtbh;
...
function editThis(xtbh) {
	location = contextPath + '/res/publicmgr/jfxx!input.action?xtbh=' + xtbh;
}