...
<div class="ui-form-search-container" id="searchcondition">
	...
	<ul>
    	<li> 
    		<span class="ui-form-input-title" style="width:60px">姓名：</span> 
    		<input id="patrolname" name="patrolname" class="ui-form-input" type="text" style="width:180px;">
    	</li>
    </ul>
    <ul>
    	<li> 
    		<span class="ui-form-input-title" style="width:60px">时间从：</span> 
    	...
    	<li> 
    		<span class="ui-form-input-title" style="width:60px">到：</span> 
