...
<html>
	<head>
		...
		<script>
			...
			In.add('zdxxdatajs',{path:'${ctx }/js/contractor/zdxxdata_list.js',type:'js',charset:'utf-8'});
			In.ready('layout','jggridjs','jggridlocalejs','zdxxdatajs',function(){
				$('.section>DIV').css("height","200");//设置tab页高度
