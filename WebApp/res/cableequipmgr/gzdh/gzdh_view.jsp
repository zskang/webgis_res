...
<script type="text/javascript">
		...
		if('${tipview}'){
       	...
       	jQuery(function(){
       		if($('#actmsg').val()){
       			...
       			parent.loadTree('tree','${ctx}/res/cableequipmgr/gzdh!getTreeNodes.action?xtbh='+$("#xtbh").val());
       		}
       	});		
	});
</script>
	...
	<body style="overflow: auto">
		<div class="ui-form-container">
			<form name="formname" id="formname" method="post" action="${ctx}/res/cableequipmgr/gzdh!input.action">
				...
				<div class="ui-form-input-box">
					...
					<span class="ui-form-value">${entity.gzdhbh}</span>
				</div>
				...
				<div class="ui-form-input-box">
					<span class="ui-form-input-title">所属机房：</span>
						...
						keyValue="${entity.ssjf}" tableName="res_jf" />
				</div>
				...
				<div class="ui-form-input-box">
					...
					<span class="ui-form-value"><baseinfo:dic
							displayProperty="LABLE" codevalue="${entity.dzbhgz}"
				...
				<div class="ui-form-input-box">
					<span class="ui-form-input-title"></span><span class="ui-form-value" style="float:right;margin-right:50px">
						<a href="${ctx}/res/cableequipmgr/gzdh!input.action?xtbh=${entity.xtbh}">编辑</a>
					</span>	
				</div>
			</form> 
		</div>
