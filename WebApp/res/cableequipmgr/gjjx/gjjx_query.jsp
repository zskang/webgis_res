	...
	<body>
		<div class="ui-form-container">
			<form name="form1" id="form1" method="post"
				action="${ctx}/res/cableequipmgr/gjjx!list.action">
				...
				<div class="ui-form-input-box">
					...
					<baseinfo:regiontree width="220" height="120" defaultValue="${searchCondition.regionid}" widgetId="001"
						callBackId="regionCallBackId" regionId="${user.regionId}" cls="ui-form-input"
						></baseinfo:regiontree>
