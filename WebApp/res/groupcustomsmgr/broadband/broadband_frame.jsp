...
<!--
	...
	In.ready('ztreejs','resztree',function(){
		...
		loadTree('tree','${ctx}/res/groupcustomsmgr/broadband!getTreeNodes.action?xtbh='+$("#xtbh").val());
		$('#contentFrame').get(0).src = "${ctx}/res/groupcustomsmgr/broadband!view.action?xtbh="+$("#xtbh").val();
	});
//-->
</script>
	<body>
