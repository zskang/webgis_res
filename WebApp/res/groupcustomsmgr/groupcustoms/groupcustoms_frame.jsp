...
<!--
	...
	In.ready('ztreejs','resztree',function(){
		...
		loadTree('tree','${ctx}/res/groupcustomsmgr/groupcustoms!getTreeNodes.action?xtbh='+$("#xtbh").val());
		$('#contentFrame').get(0).src = "${ctx}/res/groupcustomsmgr/groupcustoms!view.action?xtbh="+$("#xtbh").val();
	});
//-->
</script>
	<body>
