...
<!--
	...
	In.ready('ztreejs','resztree',function(){
		...
		loadTree('tree','${ctx}/res/groupcustomsmgr/campus!getTreeNodes.action?xtbh='+$("#xtbh").val());
		$('#contentFrame').get(0).src = "${ctx}/res/groupcustomsmgr/campus!view.action?xtbh="+$("#xtbh").val();
	});
//-->
</script>
	<body>
