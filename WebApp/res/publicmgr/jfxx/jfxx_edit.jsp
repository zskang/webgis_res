		        ...
		        In.css('.ui-form-input {width:210px} .ui-form-input-title{width:100px}');
	         	...
	         	jQuery("#formname").validate({
					...
					submitHandler : function(form) {
						...
						$.ajax({
							url:'${ctx}/res/publicmgr/jfxx!batchEdit.action',
							dataType:'html',
			...
			<form name="formname" id="formname" method="post" action="">
				...
				<input type="hidden" id="serializeQueryCondition" name="serializeQueryCondition" />
				  ...
				  <div class="ui-form-input-box">
				    ...
				    <baseinfo:dicselector name="jflx" columntype="JFLX"   type="select" keyValue="${entity.jflx}" cssClass="required ui-form-input" isQuery="query"></baseinfo:dicselector>
				...
				<div class="ui-form-input-box">
					...
					<baseinfo:dicselector name="whfs" columntype="WHFS"
						  type="select" keyValue="${entity.whfs}"
						cssClass="required ui-form-input" isQuery="query"></baseinfo:dicselector>
						<span class="ui-form-symbol-color">*</span>
				</div>
				  <div class="ui-form-input-box">
				    <span class="ui-form-input-title">所属区域：</span>
					<baseinfo:regiontree widgetId="001" defaultValue="${entity.regionid}" width="210" height="220"  
					cls="required ui-form-input" callBackId="regionCallBackId" regionId="${user.regionId}"></baseinfo:regiontree>
					<input type="hidden" class="required" id="regionid" name="regionid" value="${entity.regionid}">				    
				 	<span class="ui-form-symbol-color">*</span>
				 </div>	
				 <div class="ui-form-input-box">
