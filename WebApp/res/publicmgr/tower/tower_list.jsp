...
<script type="text/javascript">
	...
	function view(towerid) {
		window.location.href = '${ctx}/res/publicmgr/tower!view.action?towerid='
				+ towerid;
	}
	//编辑
	function editit(towerid) {
		window.location.href = '${ctx}/res/publicmgr/tower!input.action?towerid='
				+ towerid;
	}
	//删除
			...
			<table cellspacing="0" cellpadding="0" border="0" align="center">
				...
				<tr>
					...
					<td><input type="text" class="inputtext Wdate"
						...
						<input type="text" class="inputtext Wdate" name="endbuilddate"
						id="endbuilddate"
				...
				<tr>
					...
					<td><baseinfo:dicselector name="propertyright"
							columntype="property_right" type="select" cssClass="inputtext"
				...
				<tr>
					<th>铁塔高度:</th>
					<td><input type="text" class="inputtext" name="towerheight"
						id="towerheight" /></td>
					<th>所在站点:</th>
				...
				<tr>
					<td colspan="4" align="center"><input type="button" value="查询"
						...
						onclick="add();" /> <baseinfo:expexcel cls="exprotButton"
							businessId="towerlist" name="导出excel"></baseinfo:expexcel></td>
				</tr>
			</table>
		</div>
		<br />
