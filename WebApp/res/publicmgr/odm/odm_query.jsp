...
<html>
	...
	<body>
		<div class="ui-form-container">
			<form name="form1" id="form1" method="post" action="${ctx}/res/publicmgr/odm!list.action">
				 ...
				 <div class="ui-form-input-box">
					...
					<baseinfo:regiontree defaultValue="${map.regionid}" widgetId="001" width="220" height="120" cls="ui-form-input" callBackId="regionCallBackId" regionId="${user.regionId}"></baseinfo:regiontree>
					<input type="hidden" class="required" id="regionid" name="regionid" value="${map.regionid }">
				 </div>
				  <div class="ui-form-input-box">
				    <span class="ui-form-input-title">网元状态：</span>
					<baseinfo:dicselector keyValue="${map.wyzt}" name="wyzt" columntype="WYZT" type="select"   cssClass="ui-form-input" isQuery="query"></baseinfo:dicselector>
				 </div>
				 <div class="ui-form-input-box">
