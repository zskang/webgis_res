...
<!--
	...
	In.ready('ztreejs','commonjs','resztree',function(){
		...
		loadTree('tree','${ctx}/res/publicmgr/zdxx!getTreeNodes.action?xtbh='+$("#xtbh").val());
		$('#rooturl').val('${ctx}/res/publicmgr/zdxx!getTreeNodes.action?xtbh='+$("#xtbh").val());//设置资源树根链接地址
		$('#contentFrame').get(0).src = "${ctx}/res/publicmgr/zdxx!view.action?xtbh="+$("#xtbh").val();
	});
//-->
</script>
	<body>
