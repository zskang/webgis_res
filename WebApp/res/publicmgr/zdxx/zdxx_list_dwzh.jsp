			...
			<table cellspacing="0" cellpadding="0" border="0" align="center">
				...
				<tr>
					...
					<td><baseinfo:regiontree widgetId="001"
							...
							cls="inputtext"></baseinfo:regiontree></td>
				</tr>
				<tr>
					<th>代维公司:</th>
					<td><baseinfo:orgtree widgetId="002"
							defaultValue="${searchCondition.orgid}" cls="inputtext"
							orgType="2" callBackId="orgCallBackId"
							regionId="${user.regionId }"></baseinfo:orgtree></td>
					<th>维护组:</th>
				...
				<tr>
					<td colspan="4" align="center"><input type="button" value="查询"
						...
						onclick="add();" />
					<baseinfo:expexcel cls="exprotButton" businessId="zdlist"
...
<script type="text/javascript">
	In.ready('autocompleteJs', 'ztreejs', 'jggridlocalejs', 'wdatepickerjs',
			'jqgridcss', 'commonjs', 'wresize', 'zdxx_common', function() {
				var jqgrid = $("#zdxxgrid").jqGrid(
						{
							url : "${ctx}/res/publicmgr/zdxx!listdata.action",
							datatype : "json",
							mtype : "GET",
							rownumbers : true,
							colNames : [ '系统编号', '资源名称', '产权性质', '站点类型',
									'所属区域', '经度', '纬度', '创建时间', '代维公司','代维组', '操作' ],
							colModel : [ {
								name : 'XTBH',
								id : 'XTBH',
								sortable : true,
