		        ...
		        In.css('.ui-form-input {width:210px} .ui-form-input-title{width:100px}');
	         	...
	         	jQuery("#formname").validate({
					...
					submitHandler : function(form) {
						...
						$.ajax({
							url:'${ctx}/res/opticcablemgr/glxx!batchEdit.action',
							dataType:'html',
		...
		<div class="ui-form-container">
			<form id="formname" name="formname" method="post" action="">
				...
				<div class="ui-form-input-box">
					...
					<baseinfo:dicselector name="ywjb" columntype="CABLETYPE" type="select" cssClass="required ui-form-input" isQuery="query" keyValue="${entity.ywjb}"></baseinfo:dicselector>
					<span class="ui-form-symbol-color">*</span>
				</div>
				<div class="ui-form-input-box">
					<span class="ui-form-input-title">设施状态：</span>
					<baseinfo:dicselector name="sszt" columntype="SSZT" type="select" cssClass="required ui-form-input" isQuery="query" keyValue="${entity.sszt}"></baseinfo:dicselector>
					<span class="ui-form-symbol-color">*</span>
				</div>
				
				<div class="ui-form-input-box">
					<span class="ui-form-input-title">产权性质：</span>
					<baseinfo:dicselector name="cqxz" columntype="property_right" type="select" cssClass="required ui-form-input" isQuery="query" keyValue="${entity.cqxz}"></baseinfo:dicselector>
					<span class="ui-form-symbol-color">*</span>
				</div>
				
				<div class="ui-form-input-box">
					<span class="ui-form-input-title">维护方式：</span>
					<baseinfo:dicselector name="whfs" columntype="WHFS" isQuery="query" type="select" cssClass="required ui-form-input" keyValue="${entity.whfs}"></baseinfo:dicselector>
					<span class="ui-form-symbol-color">*</span>
				</div>												
				<div class="ui-form-input-box">
					<span class="ui-form-input-title">网元状态：</span>
					<baseinfo:dicselector name="wyzt" columntype="WYZT" type="select" isQuery="query" keyValue="${entity.wyzt}" cssClass="ui-form-input"></baseinfo:dicselector>
				</div>
				<div class="ui-form-input-box">
					<span class="ui-form-input-title">所属区域:</span>
					<baseinfo:regiontree defaultValue="${entity.regionid}"  width="210" height="120" cls="required ui-form-input" widgetId="001" callBackId="regionCallBackId" regionId="${user.regionId}"></baseinfo:regiontree>
