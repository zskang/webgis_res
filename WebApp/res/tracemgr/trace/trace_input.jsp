		...
		<div class="ui-form-container">
			<form id="formname" name="formname" method="post" action="${ctx}/res/tracemgr/trace!trace.action">
				<div class="ui-form-input-box">
					<span class="ui-form-input-title">起端类型：</span>
					<baseinfo:dicselector name="qssblx" columntype="CSSBLX" id="qdlx" onChange="qdlxChange();" exclude="AA002,AA005" cssClass="required ui-form-input" type="select" isQuery="select"></baseinfo:dicselector>
					<span class="ui-form-symbol-color">*</span>
				</div>
				<br>
				<div class="ui-form-input-box">
					<span class="ui-form-input-title">起端设备：</span>
					<input type="text" class="required ui-form-input" id="Qdmcinput" name="Qdmcinput" onblur="judgeHiddenValue(this,'qdmc');">
				...
				<div class="ui-form-input-box" id="odmdiv" style="display:none;">
					...
					<select name="ssodm" id="ssodm" class="required ui-form-input">
				...
				<div class="ui-form-input-box">
					...
					<select name="qssbdz" id="qssbdz" class="ui-form-input">
