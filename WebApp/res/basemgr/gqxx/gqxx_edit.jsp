...
<html>
	<head>
		...
		<script type="text/javascript">
	        ...
	        In.ready('ztreejs','autocompleteJs','commonjs','validatejs','ctcss',function(){
		        ...
		        In.css('.ui-form-input {width:210px} .ui-form-input-title{width:100px}');
	         	...
	         	jQuery("#formname").validate({
					...
					submitHandler : function(form) {
						...
						$.ajax({
							url:'${ctx}/res/basemgr/gqxx!batchEdit.action',
							dataType:'html',
	...
	<body style="overflow: auto">
		<div class="ui-form-container">
			<form id="formname" name="formname" method="post" action="http://www.baidu.com">
