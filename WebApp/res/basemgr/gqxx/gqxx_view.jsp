	...
	<body style="overflow: auto">
		<div class="ui-form-container">
			<form name="formname" id="formname" method="post"
				action="${ctx}/res/basemgr/gqxx!input.action">
		...
		<div class="ui-form-input-box">
					...
					<span class="ui-form-value">
									<baseinfo:dic displayProperty="LABLE"
			...
			<div class="ui-form-input-box">
				...
				<div class="ui-form-input-box">
					...
					<span class="ui-form-value">
									<baseinfo:dic displayProperty="LABLE"
										codevalue="${entity.whfs}" columntype="WHFS"></baseinfo:dic>
							</span>
				</div>
					...
					<span class="ui-form-value">
									<baseinfo:dic displayProperty="LABLE" codevalue="${entity.yt}"
										columntype="SSYT"></baseinfo:dic>
							</span>
				</div>
			...
			<div class="ui-form-input-box">
					...
					<span class="ui-form-value">
									<baseinfo:dic displayProperty="LABLE" codevalue="${entity.isdanger}"
			...
			<div class="ui-form-input-box">
				...
				<div class="ui-form-input-box">
					<span class="ui-form-input-title"></span><span class="ui-form-value" style="float:right;margin-right:50px">
						<a href="${ctx}/res/basemgr/gqxx!input.action?xtbh=${entity.xtbh}">编辑</a>
					</span>	
				</div>
			</form>
		</div>
