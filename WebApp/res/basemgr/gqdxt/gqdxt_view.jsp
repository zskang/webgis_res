...
<html>
	...
	<body style="overflow: auto">
		<div class="ui-form-container">
			<form name="formname" id="formname" method="post" action="${ctx}/res/basemgr/gqdxt!input.action">
				...
				<div class="ui-form-input-box">
					...
					<span class="ui-form-value">${entity.gqsl}</span>
				</div>
				...
				<div class="ui-form-input-box">
					<span class="ui-form-input-title"></span><span class="ui-form-value" style="float:right;margin-right:50px">
						<a href="${ctx}/res/basemgr/gqdxt!input.action?xtbh=${entity.xtbh}">编辑</a>
					</span>	
				</div>
			</form>
		</div>
