...
<html>
	<head>
       ...
       var checkBsd=function()
	        {
	            if($('#qdbshidden').val() != '' && $('#zdbshidden').val() != '')
	            {
	                 	$.ajax({
							   type: "POST",
							   dataType: "json",
							   url: "${ctx}/res/basemgr/bsd!checkBsd.action",
							   data: "qdbs="+$('#qdbshidden').val()+"&zdbs="+$('#zdbshidden').val(),
	...
	<body>
		<div class="ui-form-container">
			<form name="formname" id="formname" method="post" action="">
				...
				<div class="ui-form-input-box">
					<span class="ui-form-input-title">所属直埋系统：</span>
				...
				<div class="ui-form-input-box">
					...
					<input id="zdbsinput" class="required ui-form-input" name="zdbsinput" type="text" onblur="judgeHiddenValue(this,'zdbshidden');parseAZ('zdbsinput');checkBsd();" class="required ui-form-input" value='<resinfo:resCommon  keyValue="${entity.zdbs}" tableName="res_bsxx"></resinfo:resCommon>' />
				...
				<div class="ui-form-input-box">
					...
					<input type="text" class="ui-form-input number" value="${entity.bsdcd}"  maxlength="50" name="bsdcd" id="bsdcd" />(米)
				</div>
