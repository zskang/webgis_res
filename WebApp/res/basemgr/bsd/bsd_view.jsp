...
<html>
	...
	<body>
		<div class="ui-form-container">
			<form name="formname" id="formname" method="post" action="${ctx}/res/basemgr/bsd!input.action">
				 ...
				 <div class="ui-form-input-box">
				    <span class="ui-form-input-title">所属直埋系统称：</span>
				    <resinfo:resCommon displayName="zymc" keyColumn="xtbh" keyValue="${entity.ssbsxt}" tableName="res_bsd_xt"/>
				    
				 </div>
				 
				 <div class="ui-form-input-box">
				    <span class="ui-form-input-title">起端标石：</span>
				     <resinfo:resCommon displayName="zymc" keyColumn="xtbh" keyValue="${entity.qdbs}" tableName="res_bsxx"/>
				 </div>
				 
				 <div class="ui-form-input-box">
				    <span class="ui-form-input-title">终端标石：</span>
				    <resinfo:resCommon displayName="zymc" keyColumn="xtbh" keyValue="${entity.zdbs}" tableName="res_bsxx"/>
				 </div>
				 
				 <div class="ui-form-input-box">
				    <span class="ui-form-input-title">直埋段长度：</span>
				    <span class="ui-form-value">${entity.bsdcd}(米)</span>
				 </div>
				 ...
				 <div class="ui-form-input-box">
					...
					<span class="ui-form-value"><baseinfo:dic displayProperty="LABLE" codevalue="${entity.sszt}" columntype="SSZT"></baseinfo:dic></span>
				 </div>
				 ...
				 <div class="ui-form-input-box">
					...
					<span class="ui-form-value"><baseinfo:dic displayProperty="LABLE" codevalue="${entity.sfgj}" columntype="SF"></baseinfo:dic></span>
				 </div>
				 
				 <div class="ui-form-input-box">
				    <span class="ui-form-input-title">用途：</span>
					<span class="ui-form-value"><baseinfo:dic displayProperty="LABLE" codevalue="${entity.yt}" columntype="SSYT"></baseinfo:dic></span>
				 </div>
				 
				 <div class="ui-form-input-box">
				    <span class="ui-form-input-title">是否共享：</span>
					<span class="ui-form-value"><baseinfo:dic displayProperty="LABLE" codevalue="${entity.sfgx}" columntype="SF"></baseinfo:dic></span>
				 </div>
				...
				<div class="ui-form-input-box">
					<span class="ui-form-input-title"></span><span class="ui-form-value" style="float:right;margin-right:50px">
						<a href="${ctx}/res/basemgr/bsd!input.action?xtbh=${entity.xtbh}">编辑</a>
					</span>	
				</div>
			</form>
		</div>
