			...
			<form name="formname" id="formname" method="post" action="">
				...
				<c:if test="${entity.xtbh==null || entity.xtbh==''}">
					<div class="ui-form-input-box">
						<div style="width:100%;height:30px;">
							...
							<input type="button" value="选择坐标" onclick="javascript:top.addPoint('A22')" />
						</div>
					</div>
					<div class="ui-form-input-box">
				...
				<div class="ui-form-input-box">
					...
					<input type="text" name="zymc" id="zymc"
						class="required ui-form-input" maxlength="50" value="${entity.zymc}" />
						<span class="ui-form-symbol-color">*</span>
				</div>
				<div class="ui-form-input-box">
					<span class="ui-form-input-title"> 原名称:</span>
					<input type="text" class="ui-form-input"  maxlength="50" value="${entity.ymc}"
						name="ymc" id="ymc" />
				</div>
				<div class="ui-form-input-box">
					<span class="ui-form-input-title"> 道路名称：</span>
					<input type="text" value="${entity.dlmc}" maxlength="100" class="ui-form-input"
						name="dlmc" id="dlmc" />
				</div>
				<div class="ui-form-input-box">
					<span class="ui-form-input-title">门牌：</span>
					<input type="text" value="${entity.mp}" maxlength="50" class="ui-form-input"
						name="mp" id="mp" />
				</div>
				<div class="ui-form-input-box">
				...
				<div class="ui-form-input-box">
					...
					<input type="text" class="ui-form-input" maxlength="100" value="${entity.jtwz}"
						name="jtwz" id="jtwz" />
				</div>
				<div class="ui-form-input-box">
					<span class="ui-form-input-title">标石用途：</span>
					<baseinfo:dicselector name="bsyt" columntype="SSYT" type="select"
						keyValue="${entity.bsyt}"  isQuery="query"
				...
				<div class="ui-form-input-box">
					...
					<baseinfo:dicselector name="bsjtlx" columntype="BSLX" type="select"
						keyValue="${entity.bsjtlx}" isQuery="query"
						cssClass="required ui-form-input"></baseinfo:dicselector>
						<span class="ui-form-symbol-color">*</span>
				</div>
				<div class="ui-form-input-box">
					<span class="ui-form-input-title">是否危险点：</span>
					<baseinfo:dicselector name="sfwxd" columntype="SF" type="select"
						keyValue="${entity.sfwxd}"  isQuery="query"
						cssClass="ui-form-input"></baseinfo:dicselector>
				</div>
				<div class="ui-form-input-box">
					<span class="ui-form-input-title">埋深：</span>
					<input type="text" class="ui-form-input number" maxlength="10" value="${entity.ms}"
						name="ms" id="ms" />米
				</div>
				<div class="ui-form-input-box">
					<span class="ui-form-input-title">所属区域：</span>
					<baseinfo:regiontree defaultValue="${entity.regionid}"  cls="required ui-form-input"
					 widgetId="001" callBackId="regionCallBackId" regionId="${user.regionId}"></baseinfo:regiontree>
				...
				<div class="ui-form-input-box">
					...
					<input type="text" class="ui-form-input" maxlength="50" value="${entity.sydw}"
						name="sydw" id="sydw" />
				</div>
				<div class="ui-form-input-box">
					<span class="ui-form-input-title">所属管理区：</span>
					<input type="text" class="ui-form-input" maxlength="100" value="${entity.ssglq}"
						name="ssglq" id="ssglq" />
				</div>
				<div class="ui-form-input-box">
					<span class="ui-form-input-title">二维码：</span>
					<input type="text" maxlength="100" value="${entity.ewm}" class="ui-form-input"
						name="ewm" id="ewm" />
				</div>
				<div class="ui-form-input-box">
