...
public class NodeBServiceImpl extends BaseServiceImpl implements NodeBService,
	...
	@Override
	public NodeBEntity view(String nodeid) {
	...
	public boolean delete(String nodeid) {
		try { 
			service.delete(view(nodeid).getSiteid(), "A37", "C31");
	...
	@Override
	@Transactional
	public boolean save(NodeBEntity entity) {
		try {
			...
			service.save(entity.getSiteid(), "A37", "C31");
			return true;
		} catch (Exception e) {
