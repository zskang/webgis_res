 ...
 */
@Service
public class BTSSiteServiceImpl extends BaseServiceImpl implements
		BTSSiteService, ExportSupport {
	...
	@Override
	public BTSSiteEntity view(String btssiteid) {
	...
	public boolean delete(String btssiteid) {
		try {
			service.delete(view(btssiteid).getSiteid(), "A38", "C31");
	...
	@Override
	@Transactional
	public boolean save(BTSSiteEntity entity) {
		try {
			...
			service.save(entity.getSiteid(), "A38", "C31");
			return true;
		} catch (Exception e) {
