...
import com.cabletech.res.service.basemgr.GjxxService;
...
@Results( {
		@Result(name = "frame", location = "/res/basemgr/gjxx/gjxx_frame.jsp"),
		@Result(name = "input", location = "/res/basemgr/gjxx/gjxx_input.jsp"),
		@Result(name = "view", location = "/res/basemgr/gjxx/gjxx_view.jsp"),
		@Result(name = "query", location = "/res/basemgr/gjxx/gjxx_query.jsp"),
		@Result(name = "list", location = "/res/basemgr/gjxx/gjxx_list.jsp"),
		@Result(name = "edit", location = "/res/basemgr/gjxx/gjxx_edit.jsp")})
@Action("gjxx")
public class GjxxAction extends BaseAction {

	private GjxxEntity entity;

	@Resource(name = "gjxxServiceImpl")
	...
	public String list()throws Exception{
		...
		String method = "queryGjxxList";
		if (conditionMap.containsKey("simid") && StringUtils.isNotBlank(conditionMap.get("simid").toString())) {
			method = "queryGjxxListWithSimid";
		}
		map = gjxxservice.queryPageMap(method, conditionMap, super.getPage("page"), super.getLimit("rows"));		
	...
	public String save() {
		...
		if(gjxxservice.saveorupdate(entity)){
	...
	protected void prepareViewModel() throws Exception {
		...
		if (StringUtils.isNotBlank(xtbh)) {
			entity = gjxxservice.getbyid(xtbh);
			request.setAttribute("entity", entity);
		} else {
			entity = new GjxxEntity();
		}
	}
	...
	public String getTreeNodes()throws Exception{
		...
		out.print(gjxxservice.getTreeNodes(entity));
		out.flush();
		return null;
	}	
	...
	public String batchDelete(){
		...
		if(gjxxservice.batchDelete(xtbhs)){
			super.outmessage("删除成功！");
		}else{
			super.outmessage("删除失败！");
		}
